...
class lwscene extends Homey.Driver
{
    ...
    async onInit()
    {
        ...
        {
            this.homey.app.updateLog(`lwscene Driver OnInit Error ${err}`);
        }
    }
    ...
    {
        return this.homey.app.getBridge().getDevicesOfType('scene');
    }
